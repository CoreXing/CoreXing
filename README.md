...
- Python
  1. 網路爬蟲應用
  2. 會使用Numpy與Pandas統整資料並使用Matplotlib讓資料視覺化
- HTML/CSS
  1. 基礎網頁設置
- VHDL
  1. 使用quartus軟體
...
|證照|發證or考試日期|成績|主要單位|
|-------|-------|-------|-------|
|中區羅浮考驗營|112/7/13|授銜羅服|中華民國童軍總會、臺中市童軍會|
...
|比賽名稱|類型/項目|年份|成績|
|---|---|---|---|
|AIS3新型態資安食物暑期課程網頁安全組|專題競賽|2023|最佳專題獎|
...
|SITCON 學⽣計算機年年會|2022|場務組組員|中央研究院人文社會科學館||
...
|AIS3新型態資安食物暑期課程|2023|學員|中華電信學院板橋所||
